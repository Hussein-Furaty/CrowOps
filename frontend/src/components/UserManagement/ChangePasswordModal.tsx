...
import type { ChangePasswordPayload, UserResponse } from '../../types';
...
interface ChangePasswordModalProps {
  ...
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (id: number, payload: ChangePasswordPayload) => Promise<void>;
}

export const ChangePasswordModal: React.FC<ChangePasswordModalProps> = ({ user, isOpen, onClose, onSubmit }) => {
    ...
    <div style={{
      ...
      <div className="glass-panel animate-fade-in" style={{ width: '100%', maxWidth: '400px', padding: '2rem', position: 'relative' }}>
        ...
        <h3 style={{ margin: '0 0 1.5rem 0', fontSize: '1.35rem', color: 'var(--text-primary)', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          <Lock size={22} color="var(--brand-primary)" /> Change Password
        </h3>
